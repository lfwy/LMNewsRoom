...
@property (nonatomic,strong) LMNewsPhoto *photo;
@property (nonatomic,strong) LMNewsPhotoView *photoView;
...
- (void)setUpPhotoView {
    self.photoView = [[LMNewsPhotoView alloc]initWithFrame:CGRectMake(0, 0, LMScreenW, LMScreenH-64)];
